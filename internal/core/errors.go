// Package core holds prmap's dependency-free domain contract: no I/O, no
...
// Code is prmap's process exit-code contract. The CLI maps a returned error to
...
// Error is prmap's structured error. On a non-zero exit the CLI prints it to
